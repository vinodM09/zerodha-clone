        ...
        <div className="container p-5">
            <div className="row">
                <div className="col-6 p-5">
                    <h1 className="mt-5 mb-3">Trust with confidence</h1>
                ...
                <img style={{paddingLeft:"18%", paddingRight:"18%", paddingTop:"3%", marginBottom:"2rem"}} src="media/images/press-logos.png" alt="press-logos" />
            </div>
        </div>
    )
}